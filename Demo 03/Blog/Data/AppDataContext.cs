...
namespace Blog.Data
{
    public class AppDataContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // Query Filters (Global query)
            // So every query in this Entity will filter by the CompanyId, so we avoid missing to filter by CompanyId in every query, EF will do this for us (append)
